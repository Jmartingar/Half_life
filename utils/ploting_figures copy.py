...
class MakePlots(object):
    ...
    def plot_by_encoder(self, name_fig=None):
        ...
        sns.boxplot(ax=ax_data4, data=self.dataset, y="Encoder", x="F1-Score", hue=self.hue, fill=False, palette=self.colors)
    ...
    def plot_by_algorithm(self, name_fig=None):
        ...
        sns.boxplot(ax=ax_data4, data=self.dataset, y="Algorithm", x="F1-Score", hue=self.hue, fill=False, palette=self.colors)
    ...
    def plot_filter_by_nlp(self, name_fig=None):
        ...
        sns.boxplot(ax=ax_data4, data=df_filter, y="Encoder", x="F1-Score", hue=self.hue, fill=False, palette=self.colors)
