...
class RegressionModels(PredictiveModel):
    ...
    def instance_ada_boost(
        self, estimator=None, n_estimators=50, learning_rate=1, loss="linear", random_state=None
    ):
    ...
    def instance_linear_regression(
    ...
    def instance_quantile(
        self, quantile=0.5, alpha=1, fit_intercept=True, solver="warn", solver_options=None
    ):
