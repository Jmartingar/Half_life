from utils.CalculatePeptideProperties import *
import sys
sys.path.insert(0, "../../")
from . import Constant

class PeptidesDescriptors(object):
    ...
    def apply_physicochemical_properties(self):
        ...
        #self.dataset["length_sequence"] = self.dataset[self.column_seq].str.len()
        ...
        for residue in Constant.LIST_RESIDUES:
